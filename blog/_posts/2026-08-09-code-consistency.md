...
# What to go for in what circumstance?

As with most software engineering topics, it depends. I would strive for
avoiding introducing new code patterns if I can, but not at all costs.
Sometimes other concerns carry more weight, for example readability,
performance, time-to-market, etc.
